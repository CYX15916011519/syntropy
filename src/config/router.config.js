        ...
        children: [
          {
            ...
            meta: { title: '物料模板设置', icon: 'tag', keepAlive: true, permission: [ 'dashboard' ] }
          }, {
            path: '/basic/icon-selector',
          ...
          {
            path: '/basic/basicBOMtempmanage',
            component: RouteView,
            meta: { title: 'BOM模板管理', icon: 'layout', permission: [ 'support' ] },
            redirect: '/basic/basicBOMtempmanage',
            children: [
              {
                path: '/basic/basicBOMtempmanage',
                name: 'BOMtempmanage',
                component: () => import('@/views/basic/TempSet/BOMtempmanage'),
                meta: { title: '自制BOM模板设置', keepAlive: true }
              },
              {
                path: '/basic/basicCBOMtempmanage',
                name: 'CBOMtempmanage',
                component: () => import('@/views/basic/TempSet/CBOMtempmanage'),
                meta: { title: '客供BOM模板设置', keepAlive: true }
              }
            ]
          }
        ]
