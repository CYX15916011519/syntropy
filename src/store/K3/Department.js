import { Get, GetAll, Save, Delete } from '@/api/K3/Department'
...
const Department = {
  ...
  actions: {
    ...
    // 获取列表
    DepartmentGetAll ({ commit }, parame) {
      return new Promise((resolve, reject) => {
        GetAll(parame)
          .then(response => {
    ...
    // 删除数据
    DepartmentDelete ({ commit }, parame) {
      return new Promise((resolve, reject) => {
        Delete(parame)
          .then(response => {
