...
const formRemarks = {
  ...
  FUnitID: { name: '	基本计量单位	 ', type: '	int	 ', required: true, OnGroup: 'basic', index: 9, api: 'MeasureUnitGetAll', params: FUnitParame },
  FOrderUnitID: { name: '	采购计量单位	 ', type: '	int	 ', required: true, OnGroup: 'basic', index: 10, api: 'MeasureUnitGetAll', params: FUnitParame },
  FSaleUnitID: { name: '	销售计量单位	 ', type: '	int	 ', required: true, OnGroup: 'basic', index: 11, api: 'MeasureUnitGetAll', params: FUnitParame },
  FProductUnitID: { name: '	生产计量单位	 ', type: '	int	 ', required: true, OnGroup: 'basic', index: 12, api: 'MeasureUnitGetAll', params: FUnitParame },
  FStoreUnitID: { name: '	库存计量单位	 ', type: '	int	 ', required: true, OnGroup: 'basic', index: 13, api: 'MeasureUnitGetAll', params: FUnitParame },
  FSecUnitID: { name: '	辅助计量单位	 ', type: '	int	 ', required: false, OnGroup: 'basic', index: 14, api: 'MeasureUnitGetAll', params: FUnitParame },
  ...
  FCheckCycle: { name: '	盘点周期	 ', type: '	int	 ', required: true, OnGroup: 'materiel', index: 13 },
  ...
  FTrack: { name: '	计价方法	 ', type: '	int	 ', required: true, OnGroup: 'quality', index: 24, List: FTrackList },
  ...
  FAcctID: { name: '	存货科目代码	 ', type: '	int	 ', required: true, OnGroup: 'materiel', index: 27, api: 'AccountGetAll', params: AccountParame },
  FSaleAcctID: { name: '	销售收入科目代码	 ', type: '	int	 ', required: true, OnGroup: 'materiel', index: 28, api: 'AccountGetAll', params: AccountParame },
  FCostAcctID: { name: '	销售成本科目代码	 ', type: '	int	 ', required: true, OnGroup: 'materiel', index: 29, api: 'AccountGetAll', params: AccountParame },
  FAPAcctID: { name: '	成本差异科目代码	 ', type: '	int	 ', required: false, OnGroup: 'materiel', index: 30, api: 'AccountGetAll', params: AccountParame },
  FAdminAcctID: { name: '	代管物资科目	 ', type: '	int	 ', required: false, OnGroup: 'materiel', index: 31, api: 'AccountGetAll', params: AccountParame },
  ...
  FBatChangeEconomy: { name: '	变动提前期批量	 ', type: '	float	 ', required: true, OnGroup: 'quality', index: 12 },
  ...
  FStdBatchQty: { name: '	标准加工批量	 ', type: '	float	 ', required: true, OnGroup: 'quality', index: 6 },
  ...
  FPOVAcctID: { name: '	采购订单差异科目代码	 ', type: '	int	 ', required: false, OnGroup: 'standard', index: 14, api: 'AccountGetAll', params: AccountParame },
  FPIVAcctID: { name: '	采购发票差异科目代码	 ', type: '	int	 ', required: false, OnGroup: 'standard', index: 15, api: 'AccountGetAll', params: AccountParame },
  FMCVAcctID: { name: '	材料成本差异科目代码	 ', type: '	int	 ', required: false, OnGroup: 'standard', index: 16, api: 'AccountGetAll', params: AccountParame },
  FPCVAcctID: { name: '	加工费差异科目代码	 ', type: '	int	 ', required: false, OnGroup: 'standard', index: 17, api: 'AccountGetAll', params: AccountParame },
  FSLAcctID: { name: '	废品损失科目代码	 ', type: '	int	 ', required: false, OnGroup: 'standard', index: 18, api: 'AccountGetAll', params: AccountParame },
  FCAVAcctID: { name: '	标准成本调整差异科目代码	 ', type: '	int	 ', required: false, OnGroup: 'standard', index: 19, api: 'AccountGetAll', params: AccountParame },
  ...
  FKanBanCapability: { name: '	看板容量	 ', type: '	int	 ', required: true, OnGroup: 'quality', index: 32 },
